...
# 1. Launch options:
# 1a. Default preset (6D, $1-$100, 3/2, 'H17', 'NS', 'DA2', 'DAS', 'SP4', 'Rank', 'RSA', 'Perfect Pairs', 'NMSE')
# 1b. Load a JSON preset
...
# 2. Store launch options somehow
